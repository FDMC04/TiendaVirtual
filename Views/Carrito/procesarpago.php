...
<div class="modal fade" id="modalTerminos" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos quaerat alias vitae ducimus hic earum fugiat ipsum, quidem, est nam a molestiae distinctio, consequuntur ab animi repellendus voluptas ipsa eum?</p>
            <br>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem labore temporibus, explicabo corrupti nam iusto eaque sunt dolore sapiente magnam id ipsam, est, ullam autem vitae? Sint odit ipsam provident.</p>
        </div>
                    ...
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
                        ...
                        <div>
                            ...
                            <div class="bor8 bg0 m-b-12">
                                <input type="text" name="state" id="txtDireccion" class="stext-111 cl8 plh3 size-111 p-lr-15" placeholder="Dirección de envío">
                            </div>
                            <div class="bor8 bg0 m-b-22">
                                <input type="text" name="postcode" id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" placeholder="Ciudad / Estado">
                            </div>
                        </div>
                        <?php }else{ ?>
                                    ...
                                    <form id="formRegister">
                                        <div class="row">
                                            ...
                                            <div class="col col-md-6 form-group">
                                                ...
                                                <input type="text" name="txtApellido" id="txtApellido" class="form-control valid validText" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col col-md-6 form-group">
                                                <label for="txtTelefono">Teléfono</label>
                                                <input type="text" name="txtTelefono" id="txtTelefono" class="form-control valid validNumber" required="" onkeypress="return controlTag(event);">
                                            </div>
                                            <div class="col col-md-6 form-group">
                                                <label for="txtEmailCliente">Email</label>
                                                <input type="email" name="txtEmailCliente" id="txtEmailCliente" class="form-control valid validEmail" required="">
                                            </div>
                                        </div>
                ...
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                    ...
                    <div id="divMetodoPago" class="notBlock">
                        <div id="divCondiciones">
                            ...
                            <a data-toggle="modal" data-target="#modalTerminos" href="#"> Términos y Condiciones </a>
                        </div>
