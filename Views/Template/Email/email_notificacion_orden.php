...
<head>
    ...
    <style type="text/css">
        ...
        table{
            width: 100%; max-width: 600px; margin: 10px auto; border: 1px solid #CCC; border-spacing: 0;
        }
...
<body>
    <div class="">
        ...
        <div class="text-center">
            <p>Si tienes preguntas sobre tu pedido, <br>pongase en contacto con nombre, telefono y correo</p>
