			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Col. Provileon Calle Olmo #810
						Tel: (+52) 821 123 4567
					</p>

					<div class="p-t-27">
						<a href="https://facebook.com/RyMind" target="_blanck" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
							<i class="fa fa-facebook"></i>
						</a>

						<a href="https://instagram.com/RyMind" target="_blanck" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						<?= NOMBRE_EMPRESA; ?> | <?= WEB_EMPRESA; ?> | <a href="https://colorlib.com" target="_blanck">Colorlib</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
