  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box flipped">
        ...
        <form id="formCambiarPass" name="formCambiasPass" class="forget-form" action="">
          ...
          <div class="form-group">
            <input name="txtPassword" id="txtPassword" class="form-control" type="password" placeholder="Nueva contraseña" required>
          </div>
          <div class="form-group">
            <input name="txtPasswordConfirm" id="txtPasswordConfirm" class="form-control" type="password" placeholder="Confirmar contraseña" required>
          </div>
