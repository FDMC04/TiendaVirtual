								...
								?>
											<div class="item-slick3" data-thumb="<?= $arrImages[$img]['url_image']; ?>">
												<div class="wrap-pic-w pos-relative">
													<img src="<?= $arrImages[$img]['url_image']; ?>" alt="IMG-PRODUCT">
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<!-- openssl_encrypt es una funcion para encriptar, la usaremos para encriptar el id y que no pueda ser modificado -->
